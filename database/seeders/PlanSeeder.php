    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                'name' => 'VIP',
                'slug' => 'vip',
                'description' => 'Максимальный тариф. Все функции системы без ограничений, персональный менеджер и индивидуальные доработки.',
                'price' => 9990000,
                'currency' => 'UZS',
                'billing_period' => 'monthly',
                'max_marketplace_accounts' => 999,
