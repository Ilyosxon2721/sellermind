    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                {{ $is_renewal ?? false ? 'Продление подписки' : 'Оплата подписки' }}
            </h1>
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('company.profile', ['tab' => 'billing']) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-medium">
