{{-- Splash Screen - Shows on PWA initial load --}}
...
<div id="splash-screen"
    ...
    <div class="splash-logo mb-6 animate-bounce-slow">
        <div class="w-28 h-28 rounded-3xl flex items-center justify-center" style="background: #EBF0FF;">
            <svg class="w-16 h-16" style="color: #2563eb;" fill="currentColor" viewBox="0 0 24 24">
    ...
    {{-- App Name --}}
    <h1 class="text-3xl font-bold mb-2 tracking-tight" style="color: #1a1a1a;">
        SellerMind
    </h1>

    {{-- Tagline --}}
    <p class="text-sm mb-8" style="color: #888;">
    ...
    <div class="relative">
        {{-- Spinner --}}
        <div class="w-10 h-10 rounded-full animate-spin" style="border: 3px solid #e5e7eb; border-top-color: #2563eb;"></div>

        {{-- Loading dots --}}
        <div class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2">
            <div class="w-2 h-2 rounded-full animate-pulse" style="background: #2563eb; opacity: 0.5; animation-delay: 0ms"></div>
            <div class="w-2 h-2 rounded-full animate-pulse" style="background: #2563eb; opacity: 0.5; animation-delay: 150ms"></div>
            <div class="w-2 h-2 rounded-full animate-pulse" style="background: #2563eb; opacity: 0.5; animation-delay: 300ms"></div>
        </div>
    </div>

    {{-- Version --}}
    <div class="absolute bottom-8 text-xs" style="color: #ccc;">
        v1.0.0
    </div>
