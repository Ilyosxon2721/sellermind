{{-- PWA Top Navbar - Native Mobile App Style --}}
...
<nav x-data="pwaTopNavbar()"
    ...
    {{-- Status bar background (for iOS notch area) --}}
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        ...
        {{-- Search bar (hidden by default, slides down when search button clicked) --}}
