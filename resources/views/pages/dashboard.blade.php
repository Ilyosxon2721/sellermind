    ...
    <div class="pwa-only min-h-screen" style="background: #f2f2f7;">
        ...
        <main class="sm-page-content"
            ...
            <div x-show="!loading" x-cloak>
                ...
                {{-- Quick Actions Grid --}}
                <div class="px-4 pb-4">
                    <p class="sm-section-title mb-2">{{ __('dashboard.quick_actions') }}</p>
                    <div class="grid grid-cols-4 gap-3">
                        {{-- Marketplaces --}}
                        <a href="/marketplaces" class="sm-quick-action" onclick="if(window.haptic) window.haptic.light()">
                            <div class="w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-500 rounded-2xl flex items-center justify-center mb-2 shadow-lg shadow-orange-500/30 relative">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                                </svg>
                                <span x-show="stats.marketplace_accounts > 0"
                                      class="absolute -top-1 -right-1 bg-white text-orange-600 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow"
                                      x-text="stats.marketplace_accounts"></span>
                            </div>
                            <span class="text-xs text-gray-600 font-medium text-center">{{ __('dashboard.mp') }}</span>
                        </a>

                        {{-- Reviews --}}
                        <a href="/reviews" class="sm-quick-action" onclick="if(window.haptic) window.haptic.light()">
                            <div class="w-14 h-14 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl flex items-center justify-center mb-2 shadow-lg shadow-yellow-500/30 relative">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                </svg>
                                <span x-show="reviews.pending_response > 0"
                                      class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow"
                                      x-text="reviews.pending_response"></span>
                            </div>
                            <span class="text-xs text-gray-600 font-medium text-center">{{ __('dashboard.reviews') }}</span>
                        </a>

                        {{-- Warehouse/Supplies --}}
                        <a href="/warehouse" class="sm-quick-action" onclick="if(window.haptic) window.haptic.light()">
                            <div class="w-14 h-14 bg-gradient-to-br from-indigo-400 to-indigo-500 rounded-2xl flex items-center justify-center mb-2 shadow-lg shadow-indigo-500/30 relative">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                </svg>
                                <span x-show="supplies.active_count > 0"
                                      class="absolute -top-1 -right-1 bg-white text-indigo-600 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow"
                                      x-text="supplies.active_count"></span>
                            </div>
                            <span class="text-xs text-gray-600 font-medium text-center">{{ __('dashboard.warehouse') }}</span>
                        </a>

                        {{-- AI Assistant --}}
                        <a href="/chat" class="sm-quick-action" onclick="if(window.haptic) window.haptic.light()">
                            <div class="w-14 h-14 bg-gradient-to-br from-pink-400 to-pink-500 rounded-2xl flex items-center justify-center mb-2 shadow-lg shadow-pink-500/30 relative">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                                </svg>
                                <span x-show="ai.running_tasks > 0"
                                      class="absolute -top-1 -right-1 bg-green-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow animate-pulse"
