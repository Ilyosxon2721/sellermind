...
<form method="GET" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100" x-ref="filterForm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
        ...
        <div>
            ...
            <select name="warehouse_id" class="w-full border border-gray-300 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" @change="$refs.filterForm.submit()">
