...
<script>
    function documentsPage() {
        return {
            filters: { warehouse_id: '<?php echo e($selectedWarehouseId); ?>', type: '', status: '' },
            items: [],
            error: '',
            loading: false,
            showModal: false,
            ...
            openCreate() {
                this.form = {
                    type: 'IN',
                    warehouse_id: this.filters.warehouse_id || '<?php echo e($selectedWarehouseId); ?>',
                    warehouse_to_id: '',
                    comment: '',
                    lines: [{sku_id: '', qty: 1, unit_cost: '', counted_qty: '', search: '', suggestions: []}],
                };
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Документы','backUrl' => '/warehouse']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Документы','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/warehouse')]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\warehouse\documents.blade.php ENDPATH**/ ?>