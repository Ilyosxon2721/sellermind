            ...
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <a href="/marketplace/<?php echo e($accountId); ?>" class="text-white/70 hover:text-white transition p-1 rounded hover:bg-white/10">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-white/70"><?php echo e($accountName ?? 'Wildberries'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="/marketplace/<?php echo e($accountId); ?>/supplies"
...
<div class="pwa-only min-h-screen" x-data="{
    ...
    async loadOrders() {
        ...
        let url = '/api/marketplace/orders?company_id=' + companyId + '&marketplace_account_id=<?php echo e($accountId); ?>';
        if (this.dateFrom) url += '&from=' + this.dateFrom;
        if (this.dateTo) url += '&to=' + this.dateTo;
    ...
    async loadStats() {
        const companyId = this.$store?.auth?.currentCompany?.id || 1;
        let url = '/api/marketplace/orders/stats?company_id=' + companyId + '&marketplace_account_id=<?php echo e($accountId); ?>';
        if (this.dateFrom) url += '&from=' + this.dateFrom;
        if (this.dateTo) url += '&to=' + this.dateTo;
        const res = await fetch(url, { headers: this.getAuthHeaders(), credentials: 'include' });
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'WB Заказы','backUrl' => '/marketplace/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'WB Заказы','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/' . $accountId)]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views/pages/marketplace/wb-orders.blade.php ENDPATH**/ ?>