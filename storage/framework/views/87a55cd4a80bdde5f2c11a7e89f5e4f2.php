                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($accountName ?? 'Uzum Market'); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="px-6 pb-4">
                <div class="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm">
                    <div class="flex items-center space-x-4">
                        ...
                        <button @click="resetFilters()" class="px-4 py-2.5 text-[#3A007D] hover:bg-purple-50 rounded-xl transition text-sm font-medium">
                            Сбросить
                        </button>
                    </div>
                </div>
...
function uzumOrdersPage() {
    return {
        ...
        syncMessage: '',
        wsConnected: false,
        shopOptions: <?php echo json_encode($__uzumShopsJson ?? [], 15, 512) ?>,
        selectedShopId: null,
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'FBS Заказы Uzum','backUrl' => '/marketplace/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'FBS Заказы Uzum','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/' . $accountId)]); ?>
...
function uzumOrdersPWA() {
    return {
        ...
        accountId: <?php echo e($accountId ?? 'null'); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\uzum-fbs-orders.blade.php ENDPATH**/ ?>