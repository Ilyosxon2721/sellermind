<div x-data="uzumProducts(<?php echo e((int) $accountId); ?>)" class="flex h-screen bg-gray-50">
...
<div class="pwa-only min-h-screen" x-data="uzumProductsPwa(<?php echo e((int) $accountId); ?>)" style="background: #f2f2f7;">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Товары Uzum','backUrl' => '/marketplace/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Товары Uzum','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/' . $accountId)]); ?>
...
<?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\partials\products_uzum.blade.php ENDPATH**/ ?>