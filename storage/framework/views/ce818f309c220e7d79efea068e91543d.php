    ...
    <div class="space-y-6">
        ...
        <div class="bg-indigo-50 border border-indigo-100 rounded-lg p-4">
            <label class="block text-sm font-medium text-gray-900 mb-2">
                <?php echo e(__('app.settings.currency.display_currency')); ?>

            </label>
            <p class="text-xs text-gray-500 mb-3"><?php echo e(__('app.settings.currency.display_currency_description')); ?></p>
            ...
            <div x-show="displayCurrencyStatus === 'success'" x-transition class="text-green-600 text-xs mt-2">✓ <?php echo e(__('app.messages.settings_saved')); ?></div>
            <div x-show="displayCurrencyStatus === 'error'" x-transition class="text-red-600 text-xs mt-2"><?php echo e(__('app.messages.save_error')); ?></div>
        </div>

        <!-- Exchange Rates Section -->
        <div>
            <h3 class="text-sm font-medium text-gray-900 mb-4"><?php echo e(__('app.settings.currency.exchange_rates')); ?></h3>
...
<div x-show="activeTab === 'navigation'" x-data="navigationSettings()">
    <h2 class="text-lg font-semibold text-gray-900 mb-2"><?php echo e(__('app.settings.navigation.title')); ?></h2>
    <p class="text-sm text-gray-500 mb-6"><?php echo e(__('app.settings.navigation.description')); ?></p>

    <div class="space-y-6">
        <!-- Position Selector -->
        <div>
            <label class="block text-sm font-medium text-gray-900 mb-3">
                <?php echo e(__('app.settings.navigation.position')); ?>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <button @click="setPosition('left')"
                    ...
                    <span><?php echo e(__('app.settings.navigation.position_left')); ?></span>
                ...
                <button @click="setPosition('top')"
                    ...
                    <span><?php echo e(__('app.settings.navigation.position_top')); ?></span>
                ...
                <button @click="setPosition('bottom')"
                    ...
                    <span><?php echo e(__('app.settings.navigation.position_bottom')); ?></span>
                ...
                <button @click="setPosition('right')"
                    ...
                    <span><?php echo e(__('app.settings.navigation.position_right')); ?></span>
        ...
        <div x-show="position === 'left' || position === 'right'" x-transition class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
                <h3 class="text-sm font-medium text-gray-900"><?php echo e(__('app.settings.navigation.collapse')); ?></h3>
                <p class="text-sm text-gray-500"><?php echo e(__('app.settings.navigation.collapse_description')); ?></p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
...
function currencySettings() {
    return {
        ...
        availableCurrencies: [
            { code: 'UZS', symbol: 'сўм', name: '<?php echo e(__("app.settings.currency.currencies.UZS")); ?>' },
            { code: 'RUB', symbol: '₽', name: '<?php echo e(__("app.settings.currency.currencies.RUB")); ?>' },
            { code: 'USD', symbol: '$', name: '<?php echo e(__("app.settings.currency.currencies.USD")); ?>' },
            { code: 'EUR', symbol: '€', name: '<?php echo e(__("app.settings.currency.currencies.EUR")); ?>' },
            { code: 'KZT', symbol: '₸', name: '<?php echo e(__("app.settings.currency.currencies.KZT")); ?>' },
        ],
        saving: false,
        saveStatus: null,
        lastUpdated: null,
