        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gray-900 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20">
                ...
                <div class="mb-12">
                    ...
                    <h1 class="text-4xl font-bold mb-4" style="color: white;">Добро пожаловать</h1>
                    <p class="text-lg" style="color: #9ca3af;">
                        Платформа управления продажами на маркетплейсах. Контроль остатков, цен и аналитики в одном окне.
                    </p>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Введите данные для входа в систему</p>
                </div>
                ...
                <form @submit.prevent="login" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Забыли пароль?</a>
                    </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600">
                        Нет аккаунта? 
                        <a href="/register" class="text-blue-600 hover:text-blue-700 font-semibold">Зарегистрироваться</a>
                    </p>
                </div>
    ...
    <div class="pwa-only min-h-screen bg-white flex flex-col"
        ...
        <div class="flex-1 flex flex-col justify-center px-6 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900">SellerMind</h1>
                <p class="text-gray-500 mt-1">Вход в аккаунт</p>
            </div>
            ...
            <form @submit.prevent="login" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-blue-600 font-medium">Забыли пароль?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Нет аккаунта?
                    <a href="/register" class="text-blue-600 font-semibold">Зарегистрироваться</a>
                </p>
            </div>
...
<?php /**PATH /Applications/MAMP/htdocs/sellermind-ai/resources/views/pages/login.blade.php ENDPATH**/ ?>