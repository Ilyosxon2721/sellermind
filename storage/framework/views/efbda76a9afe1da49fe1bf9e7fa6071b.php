...
<div x-data="passesManager(<?php echo e($accountId); ?>)" x-init="init()" class="browser-only container mx-auto px-4 py-6">
    <!-- Header -->
                ...
                <template x-for="pass in passes" :key="pass.id">
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                            <button @click="deletePass(pass.id)" class="text-red-600 hover:text-red-800">Удалить</button>
                        </td>
                    </tr>
                </template>
            </tbody>
    ...
    <div x-show="showCreateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" x-cloak>
        <div @click.away="showCreateModal = false" class="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div class="flex gap-2 mt-4">
                <button @click="createPass()" class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg">Создать</button>
...
<div class="pwa-only min-h-screen" x-data="passesManager(<?php echo e($accountId); ?>)" x-init="init()" style="background: #f2f2f7;">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Пропуски WB','backUrl' => '/marketplace/wb/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Пропуски WB','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/wb/' . $accountId)]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\passes.blade.php ENDPATH**/ ?>