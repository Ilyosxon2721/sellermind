            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                        <span><?php echo e(__('marketplace.title')); ?></span>
                    ...
                    <p class="text-gray-500 text-sm mt-1"><?php echo e(__('marketplace.subtitle')); ?></p>
                </div>
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="text-sm font-medium"
                                              :class="{
                                                  ...
                                                  'text-[#005BFF]': marketplace.code === 'ozon',
                                                  'text-[#8B6914]': marketplace.code === 'ym'
                                              }"><?php echo e(__('marketplace.add_account')); ?></span>
                                    </button>
                                </div>
                            </div>
                        </template>
