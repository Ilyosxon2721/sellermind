...
<div x-data="suppliesManager(<?php echo e($accountId); ?>)" x-init="init()" class="browser-only container mx-auto px-4 py-6">
    <!-- Header -->
...
<div class="pwa-only min-h-screen" x-data="suppliesManager(<?php echo e($accountId); ?>)" x-init="init()" style="background: #f2f2f7;">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Поставки','backUrl' => '/marketplace/wb/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Поставки','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/wb/' . $accountId)]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\supplies.blade.php ENDPATH**/ ?>