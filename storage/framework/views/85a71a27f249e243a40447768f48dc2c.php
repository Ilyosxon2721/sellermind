...
<form method="GET" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100" x-ref="filterForm">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('web.products.index')); ?>" class="text-sm text-gray-500 hover:text-gray-700">Сбросить</a>
    </div>
        ...
        <div class="flex items-end">
            <label class="inline-flex items-center space-x-2 cursor-pointer">
                <input type="checkbox" name="is_archived" value="1"
                       @change="$refs.filterForm.submit()"
                       <?php if($filters['is_archived'] ?? false): echo 'checked'; endif; ?>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex items-center space-x-4">
        ...
        <div>
            <div class="text-2xl font-bold text-gray-900"><?php echo e($products->where('is_active', true)->count()); ?></div>
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex items-center space-x-4">
        ...
        <div>
            <div class="text-2xl font-bold text-gray-900"><?php echo e($products->sum('variants_count')); ?></div>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($image?->file_path): ?>
                                <img src="<?php echo e($image->file_path); ?>" alt="" class="h-14 w-14 object-cover rounded-xl">
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-xs text-gray-500">#<?php echo e($product->id); ?></div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($product->article); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700">
                            <?php echo e(optional($categories->firstWhere('id', $product->category_id))->name ?? '—'); ?>

                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium"><?php echo e($product->variants_count); ?></span>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600"><?php echo e(optional($product->updated_at)->format('d.m.Y H:i')); ?></td>
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo e(route('web.products.edit', $product)); ?>" class="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm transition-colors">
                                Редактировать
                            </a>
                        </td>
                    </tr>
...
<?php /**PATH D:\server\OSPanel\home\sellermind\resources\views/products/partials/browser-content.blade.php ENDPATH**/ ?>