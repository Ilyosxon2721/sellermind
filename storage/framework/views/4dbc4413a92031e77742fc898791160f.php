    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6">
            ...
            <div x-show="!loading && products.length === 0" class="flex flex-col items-center justify-center h-64">
                ...
                <a href="/marketplace/<?php echo e($accountId); ?>/ym-settings" 
    ...
    return {
        ...
        async loadProducts() {
            ...
            try {
                ...
                const res = await fetch(`/marketplace/<?php echo e($accountId); ?>/products/json?${params}`, {
        ...
        async linkVariant(productId, variantId) {
            try {
                const res = await fetch(`/api/marketplace/variant-links/accounts/<?php echo e($accountId); ?>/products/${productId}/link`, {
                    method: 'POST',
                    headers: this.getAuthHeaders(),
                    body: JSON.stringify({
        ...
        async unlinkVariant(productId) {
            ...
            try {
                const res = await fetch(`/api/marketplace/variant-links/accounts/<?php echo e($accountId); ?>/products/${productId}/unlink`, {
                    method: 'DELETE',
                    headers: this.getAuthHeaders()
                });
        ...
        async syncProductStock(productId) {
            ...
            try {
                const res = await fetch(`/api/marketplace/variant-links/accounts/<?php echo e($accountId); ?>/products/${productId}/sync-stock`, {
                    method: 'POST',
                    headers: this.getAuthHeaders()
                });
        ...
        async loadProductLinks(productId) {
            try {
                const res = await fetch(`/api/marketplace/variant-links/accounts/<?php echo e($accountId); ?>/products/${productId}/links`, {
                    headers: this.getAuthHeaders()
                });
...
<div class="pwa-only min-h-screen" x-data="ymProductsPwa(<?php echo e((int) $accountId); ?>)" style="background: #f2f2f7;">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Товары YM','backUrl' => '/marketplace/' . $accountId]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Товары YM','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/marketplace/' . $accountId)]); ?>
...
<?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\partials\products_ym.blade.php ENDPATH**/ ?>