...
<script>
    function reservationsPage() {
        return {
            filters: { warehouse_id: '<?php echo e($selectedWarehouseId); ?>', status: 'ACTIVE', reason: '' },
            items: [],
            error: '',
            loading: false,
            toast: { show: false, message: '', type: 'success' },
            showModal: false,
            form: { warehouse_id: '<?php echo e($selectedWarehouseId); ?>', sku_id: '', qty: 1, reason: 'MANUAL' },
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Резервы','backUrl' => '/warehouse']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Резервы','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/warehouse')]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\warehouse\reservations.blade.php ENDPATH**/ ?>