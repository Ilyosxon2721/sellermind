    ...
    <div class="min-h-screen flex browser-only">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gray-900 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20">
                ...
                <div class="mb-12">
                    ...
                    <h1 class="text-4xl font-bold mb-4" style="color: white;"><?php echo e(__('auth.register_hero_title')); ?></h1>
                    <p class="text-lg" style="color: #9ca3af;">
                        <?php echo e(__('auth.register_hero_subtitle')); ?>
                ...
                <div class="space-y-5">
                    <div class="flex items-center space-x-4">
                        ...
                        <span style="color: white;"><?php echo e(__('auth.benefit_trial')); ?></span>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span style="color: white;"><?php echo e(__('auth.benefit_no_card')); ?></span>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span style="color: white;"><?php echo e(__('auth.benefit_quick_setup')); ?></span>
                    </div>
                </div>
                
                <!-- Testimonial -->
                <div class="mt-12 p-6 bg-white/5 rounded-2xl border border-white/10">
                    <p class="italic mb-4" style="color: #e5e7eb;">"<?php echo e(__('auth.testimonial_text')); ?>"</p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center font-bold" style="color: white;">АМ</div>
                        <div class="ml-4">
                            <div class="font-medium" style="color: white;"><?php echo e(__('auth.testimonial_author')); ?></div>
                            <div style="color: #9ca3af;"><?php echo e(__('auth.testimonial_role')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
            <div class="w-full max-w-md">
                ...
                <!-- Form Header -->
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e(__('auth.register_title')); ?></h2>
                    <p class="text-gray-600"><?php echo e(__('auth.register_subtitle')); ?></p>
                </div>
                ...
                <form @submit.prevent="register" class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('auth.name')); ?></label>
                    ...
                    <button type="submit" :disabled="loading"
                        ...
                        <span x-show="!loading"><?php echo e(__('auth.register_button')); ?></span>
...
<?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\register.blade.php ENDPATH**/ ?>