        ...
        <header class="uzum-header">
            <div class="flex items-center justify-between max-w-full">
                <div class="flex items-center space-x-4">
                    <a href="/marketplace/<?php echo e($accountId); ?>" class="uzum-back-btn">
...
function uzumSettingsPage() {
    return {
        ...
        async loadSettings() {
            ...
            try {
                const authStore = this.$store.auth;
                const res = await this.authFetch(`/api/marketplace/uzum/accounts/<?php echo e($accountId); ?>/settings?company_id=${authStore.currentCompany.id}`);
                if (res.ok) {
                    const data = await res.json();
                    ...
                    window.location.href = '/marketplace/<?php echo e($accountId); ?>';
        ...
        async loadShops() {
            ...
            try {
                const res = await this.authFetch('/api/marketplace/uzum/accounts/<?php echo e($accountId); ?>/shops');
                if (res.ok) {
                    const data = await res.json();
        ...
        async saveSettings() {
            ...
            try {
                ...
                const res = await this.authFetch('/api/marketplace/uzum/accounts/<?php echo e($accountId); ?>/settings', {
                    method: 'PUT',
        ...
        async testConnection() {
            ...
            try {
                const res = await this.authFetch(`/api/marketplace/uzum/accounts/<?php echo e($accountId); ?>/test?company_id=${authStore.currentCompany.id}`, {
                    method: 'POST'
                });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\uzum-settings.blade.php ENDPATH**/ ?>