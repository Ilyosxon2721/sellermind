...
<script>
    window.marketplaceCredentialFields = <?php echo json_encode(config('marketplaces.credential_fields')); ?>;
</script>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900"><?php echo e(__('marketplace.title')); ?></h1>
                    <p class="text-gray-600 text-sm"><?php echo e(__('marketplace.subtitle')); ?></p>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 overflow-y-auto p-6">
            ...
            <div x-show="!loading" x-cloak>
                <!-- Connected Accounts -->
                <div class="mb-8">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('marketplace.connected_accounts')); ?></h2>

                    <p x-show="accounts.length === 0 && !creatingAccount" class="text-sm text-gray-500 mb-4">
                        <?php echo e(__('marketplace.no_accounts')); ?>
                            ...
                            <div class="py-6" :class="index === 0 ? 'pt-0' : ''">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div @click="window.location.href = '/marketplace/' + account.id"
                                            ...
                                            <div x-show="account.isDeleting" class="absolute inset-0 bg-white/80 rounded-xl flex items-center justify-center z-10">
                                                <div class="flex items-center space-x-2 text-gray-600">
                                                    ...
                                                    <span class="text-sm font-medium"><?php echo e(__('marketplace.deleting')); ?></span>
                                                </div>
                                            </div>
                                            <div class="flex items-start justify-between mb-4">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-500">
                                                            <span x-show="account.is_active" class="text-green-600"><?php echo e(__('marketplace.active')); ?></span>
                                                            <span x-show="!account.is_active" class="text-gray-400"><?php echo e(__('marketplace.disabled')); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex space-x-2">
                                                    <a :href="getAccountProductsUrl(account)"
                                                       ...
                                                       class="flex-1 px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 text-center transition">
                                                        <?php echo e(__('marketplace.products')); ?>

                                                    </a>
                                                    <a :href="getAccountOrdersUrl(account)"
                                                       @click.stop
                                                       class="flex-1 px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 text-center transition">
                                                        <?php echo e(__('marketplace.orders')); ?>
                                                ...
                                                <div class="flex space-x-2" x-show="account.marketplace === 'wb'">
                                                    <a :href="'/marketplace/' + account.id + '/supplies'"
                                                       ...
                                                       class="flex-1 px-3 py-2 bg-purple-50 text-purple-700 text-sm rounded-lg hover:bg-purple-100 text-center transition">
                                                        <?php echo e(__('marketplace.supplies')); ?>

                                                    </a>
                                                    <a :href="'/marketplace/' + account.id + '/passes'"
                                                       @click.stop
                                                       class="flex-1 px-3 py-2 bg-purple-50 text-purple-700 text-sm rounded-lg hover:bg-purple-100 text-center transition">
                                                        <?php echo e(__('marketplace.passes')); ?>
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="mt-2 text-sm text-gray-500"><?php echo e(__('marketplace.add_account')); ?></span>
                                    </button>
                                </div>
                            </div>
                        </template>
                ...
                <form @submit.prevent="connectMarketplace">
                    ...
                    <div class="mt-6 flex space-x-3">
                        <button type="button"
                            ...
                            <?php echo e(__('marketplace.cancel')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Маркетплейсы','backUrl' => '/dashboard']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Маркетплейсы','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/dashboard')]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views\pages\marketplace\index.blade.php ENDPATH**/ ?>