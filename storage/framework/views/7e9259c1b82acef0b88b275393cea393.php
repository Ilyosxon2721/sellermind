    ...
    <div class="flex-1 flex flex-col overflow-hidden"
        ...
        <header class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900"><?php echo e(__('app.settings.title')); ?></h1>
                    <p class="text-sm text-gray-500"><?php echo e(__('app.settings.subtitle')); ?></p>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="border-b border-gray-200 mb-6">
                    <nav class="-mb-px flex space-x-8">
                        <button @click="activeTab = 'profile'"
                            ...
                            <?php echo e(__('app.settings.tabs.profile')); ?>
                        ...
                        <button @click="activeTab = 'language'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.language')); ?>
                        ...
                        <button @click="activeTab = 'telegram'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.telegram')); ?>
                        ...
                        <button @click="activeTab = 'security'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.security')); ?>
                        ...
                        <button @click="activeTab = 'sync'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.sync')); ?>
                        ...
                        <button @click="activeTab = 'currency'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.currency')); ?>
                        ...
                        <button @click="activeTab = 'navigation'"
                                ...
                                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            <?php echo e(__('app.settings.tabs.navigation')); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <?php echo $__env->make('pages.partials.settings-tabs', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </main>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pwa-header','data' => ['title' => 'Настройки']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Настройки']); ?>
        ...
        async updateProfile() {
            try {
                ...
                if (response.ok) {
                    ...
                    if (window.toast) {
                        window.toast.success('<?php echo e(__('app.messages.profile_updated')); ?>');
                    } else {
                        alert('<?php echo e(__('app.messages.profile_updated')); ?>');
                    }
                } else {
                    if (window.toast) {
                        window.toast.error('<?php echo e(__('app.messages.error')); ?>');
                    } else {
                        alert('<?php echo e(__('app.messages.error')); ?>');
                    }
                }
            } catch (error) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\server\OSPanel\home\sellermind\resources\views/pages/settings.blade.php ENDPATH**/ ?>