    ...
    protected function onProductUpdated(array $data, int $companyId, array $message = [], ?IntegrationLink $link = null): void
    {
        ...
        try {
            ...
            if (isset($data['article'])) {
                $fields['article'] = $data['article'];
            }
            if (isset($data['brand'])) {
                $fields['brand_name'] = $data['brand'];
            }
            if (isset($data['brand_name'])) {
                $fields['brand_name'] = $data['brand_name'];
            }
            if (isset($data['description'])) {
                $fields['description_full'] = $data['description'];
            }
            if (isset($data['short_description'])) {
                $fields['description_short'] = $data['short_description'];
            }
            ...
            if (! empty($variants)) {
                foreach ($variants as $i => $variantData) {
                    ...
                    if ($existingVariant) {
                        ...
                        if (isset($variantData['name'])) {
                            $variantFields['name'] = $variantData['name'];
                        }
                        if (isset($variantData['variant_name'])) {
                            $variantFields['name'] = $variantData['variant_name'];
                        }
                        if (isset($variantData['title'])) {
                            $variantFields['name'] = $variantData['title'];
                        }
                        if (isset($variantData['sku'])) {
                            $variantFields['sku'] = $variantData['sku'];
                        }
                        if (isset($variantData['sku_code'])) {
                            $variantFields['sku'] = $variantData['sku_code'];
                        }
                        if (isset($variantData['barcode'])) {
                            $variantFields['barcode'] = $variantData['barcode'];
                        }
                        if (isset($variantData['price'])) {
                            $variantFields['price_default'] = $variantData['price'];
                        }
                        if (isset($variantData['sell_price'])) {
                            $variantFields['price_default'] = $variantData['sell_price'];
                        }
                        if (isset($variantData['purchase_price'])) {
                            $variantFields['purchase_price'] = $variantData['purchase_price'];
                        }
                        if (isset($variantData['cost_price'])) {
                            $variantFields['purchase_price'] = $variantData['cost_price'];
                        }
                        if (isset($variantData['weight'])) {
                            $variantFields['weight_g'] = $variantData['weight'];
                        }
                        if (isset($variantData['weight_g'])) {
                            $variantFields['weight_g'] = $variantData['weight_g'];
                        }
                        if (isset($variantData['length'])) {
                            $variantFields['length_mm'] = $variantData['length'];
                        }
                        if (isset($variantData['length_mm'])) {
                            $variantFields['length_mm'] = $variantData['length_mm'];
                        }
                        if (isset($variantData['width'])) {
                            $variantFields['width_mm'] = $variantData['width'];
                        }
                        if (isset($variantData['width_mm'])) {
                            $variantFields['width_mm'] = $variantData['width_mm'];
                        }
                        if (isset($variantData['height'])) {
                            $variantFields['height_mm'] = $variantData['height'];
                        }
                        if (isset($variantData['height_mm'])) {
                            $variantFields['height_mm'] = $variantData['height_mm'];
                        }
                        if (isset($variantData['dims_l'])) {
                            $variantFields['length_mm'] = $variantData['dims_l'];
                        }
                        if (isset($variantData['dims_w'])) {
                            $variantFields['width_mm'] = $variantData['dims_w'];
                        }
                        if (isset($variantData['dims_h'])) {
                            $variantFields['height_mm'] = $variantData['dims_h'];
                        }
                        if (isset($variantData['risment_variant_id'])) {
                            $variantFields['risment_variant_id'] = $variantData['risment_variant_id'];
                        }
                        if (isset($variantData['variant_id'])) {
                            $variantFields['risment_variant_id'] = $variantData['variant_id'];
                        }
                        if (array_key_exists('is_active', $variantData)) {
                            $variantFields['is_active'] = (bool) $variantData['is_active'];
                        }
                ...
                if ($variant) {
                    $variantFields = [];
                    if (isset($data['sku'])) {
                        $variantFields['sku'] = $data['sku'];
                    }
                    if (isset($data['barcode'])) {
                        $variantFields['barcode'] = $data['barcode'];
                    }
                    if (isset($data['price'])) {
                        $variantFields['price_default'] = $data['price'];
                    }
                    if (isset($data['cost_price'])) {
                        $variantFields['purchase_price'] = $data['cost_price'];
                    }
                    if (isset($data['weight'])) {
                        $variantFields['weight_g'] = $data['weight'];
                    }
                    if (isset($data['length'])) {
                        $variantFields['length_mm'] = $data['length'];
                    }
                    if (isset($data['width'])) {
                        $variantFields['width_mm'] = $data['width'];
                    }
                    if (isset($data['height'])) {
                        $variantFields['height_mm'] = $data['height'];
                    }
